...
opts.Add(PathVariable('target_name', 'The library name.', 'gd_vosk', PathVariable.PathAccept))
...
env.Append(LIBPATH=[cpp_bindings_path + 'bin/', "libpath"])
env.Append(LIBS=[cpp_library,"libvosk",])
